...
This project is an artist portfolio website designed to showcase the artwork of Steve Johnson. The website is built using HTML, CSS, and Bootstrap to create a responsive and visually appealing gallery of artworks.
...
- **Navigation:** Use the navigation bar to jump between different sections of the site, such as "Portfolio", "About", and "Contact".
